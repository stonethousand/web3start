...
const Welcome = () => {
  ...
  return (
    <div className='flex w-full justify-center items-center'>
      <div className="flex md:flex-row flex-col items-start justify-between ms:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col md:mr-10">
          <h1 className='text-3xl sm:text5xl text-white text-gradient py-1'>
            Send ethereum(sepolia-test) <br /> across the world
          </h1>
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Explore the crypto world. Buy and sell cryptocurremcies easily on Krypto
          </p>
          {
